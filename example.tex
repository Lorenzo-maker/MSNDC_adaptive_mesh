...
The advantages of the $\pnh$ method with to the $ph$ one, are shown in Table~\ref{tab:tablefree}. Under the same practical accuracy, $\pnh$ method guarantees $\sim 20\%$ less NLP variables involved and $\sim 27\%$ reduction in total time with respect to the $ph$ counterpart.
